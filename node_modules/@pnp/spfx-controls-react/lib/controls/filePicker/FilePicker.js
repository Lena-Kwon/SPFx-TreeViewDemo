...
var FilePicker = /** @class */ (function (_super) {
    ...
    FilePicker.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "pnp__file-picker" },
            ...
            this.props.buttonIcon || this.props.buttonIconProps ? (React.createElement(ActionButton, __assign({ iconProps: buttonIconProps }, buttonProps))) : (React.createElement(PrimaryButton, __assign({}, buttonProps))),
            React.createElement(Panel, { isOpen: this.state.panelOpen, isBlocking: true, hasCloseButton: true, className: "pnp__file-picker__panel " + styles.filePicker + " " + panelClassName, onDismiss: this._handleClosePanel, type: PanelType.extraLarge, isFooterAtBottom: true, onRenderNavigation: function () {
                    return undefined;
                ...
                React.createElement("div", { className: styles.tabsContainer },
                    this.state.selectedTab === "keyLink" && (React.createElement(LinkFilePickerTab, __assign({ fileSearchService: this.fileSearchService, renderCustomLinkTabContent: this.props.renderCustomLinkTabContent, allowExternalTenantLinks: true }, linkTabProps))),
                    ...
                    this.state.selectedTab === "keySite" && (React.createElement(SiteFilePickerTab, __assign({ fileBrowserService: this.fileBrowserService, includePageLibraries: this.props.includePageLibraries }, linkTabProps))),
