...
import { DocumentCard, DocumentCardActions, DocumentCardPreview } from 'office-ui-fabric-react/lib/DocumentCard';
...
var ListItemAttachments = /** @class */ (function (_super) {
    ...
    ListItemAttachments.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.ListItemAttachments },
            React.createElement(UploadAttachment, { listId: this.props.listId, itemId: this.props.itemId, disabled: this.props.disabled, context: this.props.context, onAttachmentUpload: this._onAttachmentUpload, fireUpload: this.state.fireUpload }),
            this.state.showPlaceHolder ?
                React.createElement(Placeholder, { iconName: 'Upload', iconText: strings.ListItemAttachmentslPlaceHolderIconText, description: strings.ListItemAttachmentslPlaceHolderDescription, buttonLabel: strings.ListItemAttachmentslPlaceHolderButtonLabel, hideButton: this.props.disabled, onConfigure: function () { return _this.setState({ fireUpload: true }); } })
                :
                    this.state.attachments.map(function (file) {
                        ...
                        return (React.createElement("div", { key: fileName, className: styles.documentCardWrapper },
                            React.createElement(TooltipHost, { content: fileName, calloutProps: { gapSpace: 0, isBeakVisible: true }, closeDelay: 200, directionalHint: DirectionalHint.rightCenter },
                                React.createElement(DocumentCard, { onClickHref: !openAttachmentsInNewWindow && file.ServerRelativeUrl + "?web=1", onClick: openAttachmentsInNewWindow && (function () { return window.open(file.ServerRelativeUrl + "?web=1", "_blank"); }), className: styles.documentCard },
