...
var ComboBoxListItemPicker = /** @class */ (function (_super) {
    ...
    ComboBoxListItemPicker.prototype.loadOptions = function (props, isInitialLoad) {
        return __awaiter(this, void 0, void 0, function () {
            var filter, keyColumnInternalName, listId, columnInternalName, webUrl, itemLimit, defaultSelectedItems, onInitialized, query, keyColumnName, listItems, options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        filter = props.filter, keyColumnInternalName = props.keyColumnInternalName, listId = props.listId, columnInternalName = props.columnInternalName, webUrl = props.webUrl, itemLimit = props.itemLimit, defaultSelectedItems = props.defaultSelectedItems, onInitialized = props.onInitialized;
                        query = filter || "";
    ...
    ComboBoxListItemPicker.prototype.componentWillReceiveProps = function (nextProps) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ComboBoxListItemPicker.prototype.render = function () {
        ...
        return (this.state.availableOptions ? (React.createElement("div", null,
            React.createElement(ComboBox, { options: this.state.availableOptions, autoComplete: this.props.autoComplete, comboBoxOptionStyles: this.props.comboBoxOptionStyles, allowFreeform: this.props.allowFreeform, keytipProps: this.props.keytipProps, onMenuDismissed: this.props.onMenuDismiss, onMenuOpen: this.props.onMenuOpen, text: this.props.text, onChange: function (e, value) { return _this.onChanged(value); }, multiSelect: this.props.multiSelect, defaultSelectedKey: this.selectedItems.map(function (item) { return item.key; }) || [], className: className, disabled: disabled }),
