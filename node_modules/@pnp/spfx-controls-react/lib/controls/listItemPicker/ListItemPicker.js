...
var ListItemPicker = /** @class */ (function (_super) {
    ...
    function ListItemPicker(props) {
        ...
        _this.loadListItems = function (filterText) { return __awaiter(_this, void 0, void 0, function () {
            var _a, listId, columnInternalName, keyColumnInternalName, webUrl, filter, orderBy, substringSearch, field, arrayItems, keyColumn, listItems, _i, listItems_1, item, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, listId = _a.listId, columnInternalName = _a.columnInternalName, keyColumnInternalName = _a.keyColumnInternalName, webUrl = _a.webUrl, filter = _a.filter, orderBy = _a.orderBy, substringSearch = _a.substringSearch;
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this._spservice.getListItems(filterText, listId, columnInternalName, field, keyColumn, webUrl, filter, substringSearch, orderBy ? orderBy : '')];
                    case 2:
                        listItems = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._spservice.getField(props.listId, props.columnInternalName, props.webUrl)];
                    case 1:
                        field = _a.sent();
                        this.setState({
                            field: field
