...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype._processProperties = function (props) {
        var dragDropFiles = props.dragDropFiles, items = props.items, iconFieldName = props.iconFieldName, viewFields = props.viewFields, groupByFields = props.groupByFields, showFilter = props.showFilter;
    ...
    ListView.prototype._executeFiltering = function (filterValue, items, columns) {
        var filterSeparator = ":";
        var filterColumns = __spreadArrays(columns);
    ...
    ListView.prototype.render = function () {
        var _this = this;
        var groupProps = {};
        var _a = this.props, showFilter = _a.showFilter, filterPlaceHolder = _a.filterPlaceHolder, dragDropFiles = _a.dragDropFiles, stickyHeader = _a.stickyHeader, selectionMode = _a.selectionMode, compact = _a.compact;
        var _b = this.state, filterValue = _b.filterValue, items = _b.items, dragStatus = _b.dragStatus, columns = _b.columns, groups = _b.groups;
        ...
        return (React.createElement(ListViewWrapper, { stickyHeader: !!this.props.stickyHeader },
            React.createElement("div", { className: styles.DragDropArea, ref: this.dropRef },
                (dragStatus && dragDropFiles) &&
                    React.createElement("div", { className: styles.DragDropAreaBorder },
                        React.createElement("div", { className: styles.DragDropAreaZone },
                            React.createElement(Icon, { iconName: "Download", className: "ms-IconExample" }),
                            React.createElement("div", null, strings.UploadFileHeader))),
                showFilter &&
                    React.createElement(SearchBoxWrapper, { stickyHeader: !!this.props.stickyHeader },
                ...
                !!items && React.createElement(DetailsList, { key: "ListViewControl", items: items, columns: columns, groups: groups, selectionMode: selectionMode || SelectionMode.none, selectionPreservedOnEmptyClick: true, selection: this._selection, layoutMode: DetailsListLayoutMode.justified, compact: compact, setKey: 'ListViewControl', groupProps: groupProps, onRenderDetailsHeader: this._onRenderDetailsHeader, componentRef: function (ref) {
                        if (ref) {
                            ref.forceUpdate();
                        }
                    } }))));
