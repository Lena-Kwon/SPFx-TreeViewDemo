...
var PeoplePicker = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        recentlyUsed = __spreadArrays(filteredPersons, mostRecentlyUsedPersons);
    ...
    PeoplePicker.prototype.getInitialPersons = function (props) {
        return __awaiter(this, void 0, void 0, function () {
            var groupName, webAbsoluteUrl, defaultSelectedUsers, ensureUser, principalTypes, _a, selectedPersons, _i, _b, userValue, valueAndTitle, userResult, inactiveUser;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.peopleSearchService.searchPersonByEmailOrLogin(valueAndTitle[0], principalTypes, webAbsoluteUrl, this.groupId, ensureUser)];
                    case 5:
                        userResult = _c.sent();
                        if (userResult) {
    ...
    PeoplePicker.prototype.render = function () {
        var _a = this.props, peoplePickerCntrlclassName = _a.peoplePickerCntrlclassName, peoplePickerWPclassName = _a.peoplePickerWPclassName, required = _a.required, titleText = _a.titleText, suggestionsLimit = _a.suggestionsLimit, placeholder = _a.placeholder, personSelectionLimit = _a.personSelectionLimit, disabled = _a.disabled, showtooltip = _a.showtooltip, tooltipMessage = _a.tooltipMessage, tooltipDirectional = _a.tooltipDirectional, errorMessageClassName = _a.errorMessageClassName;
        var _b = this.state, selectedPersons = _b.selectedPersons, resolveDelay = _b.resolveDelay, errorMessage = _b.errorMessage, internalErrorMessage = _b.internalErrorMessage;
        var suggestionProps = {
        ...
        var peoplepicker = (React.createElement("div", { id: "people", className: styles.defaultClass + " " + (peoplePickerWPclassName ? peoplePickerWPclassName : '') },
            ...
            React.createElement(NormalPeoplePicker, { pickerSuggestionsProps: suggestionProps, onResolveSuggestions: this.onSearchFieldChanged, onEmptyInputFocus: this.returnMostRecentlyUsedPerson, getTextFromItem: function (peoplePersonaMenu) { return peoplePersonaMenu.text; }, className: "ms-PeoplePicker " + (peoplePickerCntrlclassName ? peoplePickerCntrlclassName : ''), key: 'normal', removeButtonAriaLabel: 'Remove', inputProps: {
                ...
                }, selectedItems: selectedPersons, itemLimit: personSelectionLimit || 1, disabled: disabled || !!internalErrorMessage, onChange: this.onChange, resolveDelay: resolveDelay })));
