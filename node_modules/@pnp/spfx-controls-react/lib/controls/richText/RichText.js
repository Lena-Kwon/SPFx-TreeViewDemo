...
var RichText = /** @class */ (function (_super) {
    ...
    function RichText(props) {
        ...
        _this.renderLinkDialog = function () {
            return (React.createElement(Dialog, { hidden: _this.state.hideDialog, onDismiss: _this.closeDialog, dialogContentProps: {
                ...
                React.createElement(TextField, { label: strings.AddressFieldLabel, value: _this.state.insertUrl !== undefined ? _this.state.insertUrl : "https://", onChange: function (e, newValue) {
                        _this.setState({
                            insertUrl: newValue
                        });
                    } }),
                ...
                React.createElement(DialogFooter, { className: styles.actions },
                    React.createElement("div", { className: "ms-Dialog-actionsRight " + styles.actionsRight },
                        _this.state.selectedUrl && (React.createElement(Link, { className: styles.action + " " + styles.unlinkButton, onClick: _this.handleRemoveLink }, strings.RemoveLinkLabel)),
    ...
    RichText.prototype.onRenderStyleOption = function (option) {
        return (React.createElement(TooltipHost, { content: option.text, id: option.text + "-toolbarButton", calloutProps: { gapSpace: 0 } },
            React.createElement("div", { className: styles.toolbarDropDownOption + " " + (option.data.className ? option.data.className : ""), "aria-describedby": option.text + "-toolbarButton" },
    ...
    RichText.prototype.onRenderStyleTitle = function (options) {
        ...
        return (React.createElement(TooltipHost, { content: option.text, id: option.text + "-dropDownTitle", calloutProps: { gapSpace: 0 } },
            React.createElement("div", { className: styles.toolbarSubmenuDisplayButton, "aria-describedby": option.text + "-dropDownTitle" },
                React.createElement("span", null, option.text))));
    };
    /**
     * Render align option
    ...
    RichText.prototype.render = function () {
        ...
        if (!isEditMode) {
            return (React.createElement("div", { className: "ql-editor " + styles.richtext + " " + (this.props.className || ''), dangerouslySetInnerHTML: { __html: text } }));
        }
        // Okay, we're in edit mode.
        var _a = this.props, placeholder = _a.placeholder, _b = _a.styleOptions, showStyles = _b.showStyles, showBold = _b.showBold, showItalic = _b.showItalic, showUnderline = _b.showUnderline, showAlign = _b.showAlign, showList = _b.showList, showLink = _b.showLink, showMore = _b.showMore, showImage = _b.showImage;
        ...
        return (React.createElement("div", { ref: function (ref) { return _this._wrapperRef = ref; }, className: (styles.richtext && this.state.editing ? 'ql-active' : '') + " " + this.props.className },
            React.createElement("div", { id: this._toolbarId, style: { top: this.state.wrapperTop } },
                showStyles && (React.createElement(Dropdown, { id: "DropDownStyles", className: styles.headerDropDown + " " + styles.toolbarDropDown, onRenderCaretDown: function () { return React.createElement(Icon, { className: styles.toolbarSubmenuCaret, iconName: "CaretDownSolid8" }); }, selectedKey: this.state.formats.header || 0, options: this.ddStyleOpts, onChanged: this.onChangeHeading, onRenderOption: this.onRenderStyleOption, onRenderTitle: this.onRenderStyleTitle })),
                ...
                showList && (React.createElement(Dropdown, { className: styles.toolbarDropDown, id: "DropDownLists", onRenderCaretDown: function () { return React.createElement(Icon, { className: styles.toolbarSubmenuCaret, iconName: "CaretDownSolid8" }); }, selectedKey: this.state.formats.list, options: this.ddListOpts, 
                    ...
                    notifyOnReselect: true, onChanged: this.onChangeList, onRenderOption: this.onRenderListOption, onRenderTitle: this.onRenderListTitle, onRenderPlaceHolder: this.onRenderListPlaceholder })),
                showLink && (React.createElement(TooltipHost, { content: strings.LinkTitle, id: "link-richtextbutton", calloutProps: { gapSpace: 0 } },
                    React.createElement(IconButton, { checked: this.state.formats.link !== undefined, onClick: this.showInsertLinkDialog, "aria-describedby": "link-richtextbutton", iconProps: {
                            iconName: 'Link'
                        } }))),
                showImage && (React.createElement(TooltipHost, { content: strings.ImageTitle, id: "image-richtextbutton", calloutProps: { gapSpace: 0 } },
                    React.createElement(IconButton, { checked: this.state.formats.link !== undefined, onClick: this.showInsertImageDialog, "aria-describedby": "image-richtextbutton", iconProps: {
            ...
            React.createElement(ReactQuill, { ref: this.linkQuill, placeholder: placeholder, modules: modules, value: text || '', onChange: this.handleChange, onChangeSelection: this.handleChangeSelection, onFocus: this.handleOnFocus }),
