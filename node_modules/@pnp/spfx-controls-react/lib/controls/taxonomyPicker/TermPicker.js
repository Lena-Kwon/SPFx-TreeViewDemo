...
var TermPicker = /** @class */ (function (_super) {
    ...
    TermPicker.prototype.onFilterChanged = function (filterText, tagList) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, termPickerHostProps, context, isTermSetSelectable, terms, termSet, filteredTerms, _b, disabledTermIds_1, disableChildrenOfDisabledParents, _loop_1, this_1, _i, terms_1, term;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(filterText !== "")) return [3 /*break*/, 8];
                        _a = this.props, termPickerHostProps = _a.termPickerHostProps, context = _a.context, isTermSetSelectable = _a.isTermSetSelectable;
