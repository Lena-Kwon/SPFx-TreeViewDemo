...
export declare function getInFlowToolbarItems(allActions: TActions, childredFactory: (action: any) => JSX.Element): ShorthandCollection<ToolbarItemProps, ToolbarItemShorthandKinds>;
export declare function getOverflowToolbarItems(allActions: TActions, childredFactory: (action: any) => JSX.Element): ShorthandCollection<ToolbarItemProps, ToolbarItemShorthandKinds>;
